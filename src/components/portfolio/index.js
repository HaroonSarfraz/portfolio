      ...
      <React.Fragment>
        <section id="portfolio">
          <div className="row">
              ...
              >
                <div className="columns portfolio-item">
                  <div className="item-wrap">
                    <a href="#modal-vendo" title>
                      <img alt="" src="images/portfolio/vendo.png" />
                      <div className="overlay">
                        <div className="portfolio-item-meta">
                          <h5>Vendo</h5>
                          <p>NextJS, ReactJS, NodeJS, NestJS</p>
                        </div>
                      </div>
                ...
                <div className="columns portfolio-item">
                  <div className="item-wrap">
                    <a href="#modal-firefighter" title>
                      <img
                        alt="FireFighter VR"
                        src="images/portfolio/firefighter.png"
                      />
                      <div className="overlay">
                        <div className="portfolio-item-meta">
            ...
            {/* Modal Popup
	      --------------------------------------------------------------- */}
            <div id="modal-vendo" className="popup-modal mfp-hide">
              <img
                className="scale-with-grid"
                src="images/portfolio/modals/vendo.png"
                alt=""
              />
              <div className="description-box">
                ...
                <span className="categories">
                  ...
                  NextJS, ReactJS, NodeJS, NestJS
                </span>
              </div>
              <div className="link-box">
                <a href="https://vendocommerce.com/" target="_blank">
                  Details
                </a>
            ...
            <div id="modal-firefighter" className="popup-modal mfp-hide">
              <img
                className="scale-with-grid"
                src="images/portfolio/modals/firefighter.png"
                alt=""
              />
              <div className="description-box">
                ...
                <p>
                  ...
                  the German Association of the factory firefighter departments
                  (WFVD) and run by the Northdocks GmbH offers a software as a
                  service platform for training in VR.
                </p>
                <span className="categories">
                  <i className="fa fa-tag" />
                  ROR
              ...
              <div className="link-box">
                <a href="https://www.firefightervr.de/" target="_blank">
                  Details
                </a>
                <a className="popup-modal-dismiss">Close</a>
              </div>
            ...
            <div id="modal-eggplant" className="popup-modal mfp-hide">
              <img
                className="scale-with-grid"
                src="images/portfolio/modals/eggplant.png"
                alt=""
              />
              <div className="description-box">
                <h4>Eggplant Dex</h4>
                ...
                <span className="categories">
                  <i className="fa fa-tag" />
                  ReactJS, web3, Binance
                </span>
              </div>
              <div className="link-box">
                <a href="https://dex.eggplantcrypto.com/" target="_blank">
                  Details
                </a>
                <a className="popup-modal-dismiss">Close</a>
              </div>
            ...
            <div id="modal-remotereps" className="popup-modal mfp-hide">
              <img
                className="scale-with-grid"
                src="images/portfolio/modals/remotereps.png"
                alt=""
              />
              <div className="description-box">
                <h4>RemoteReps</h4>
                <p>
                  Remote Reps provides the needed solution: a virtual sales and
                  service workforce, sourced from our strong network of
              ...
              <div className="link-box">
                <a href="https://office.remotereps.com/" target="_blank">
                  Details
                </a>
                <a className="popup-modal-dismiss">Close</a>
              </div>
            ...
            <div id="modal-rageon" className="popup-modal mfp-hide">
              <img
                className="scale-with-grid"
                src="images/portfolio/modals/rageon.jpg"
                alt=""
              />
              <div className="description-box">
                <h4>RageOn</h4>
                <p>
                  RageOn.com is the World’s Largest All-Over-Print Online Store
                  that features over 150 licensed celebrities, brands, and
                  artists from all over the world. Here users can create
              ...
              <div className="link-box">
                <a href="https://rageon.com/" target="_blank">
                  Details
                </a>
                <a className="popup-modal-dismiss">Close</a>
              </div>
            ...
            <div id="modal-hrms" className="popup-modal mfp-hide">
              <img
                className="scale-with-grid"
                src="images/portfolio/modals/hrms.png"
                alt=""
              />
              <div className="description-box">
                <h4>HRMS</h4>
            ...
            <div id="modal-acloud" className="popup-modal mfp-hide">
              <img
                className="scale-with-grid"
                src="images/portfolio/modals/acloud.jpg"
                alt=""
              />
              <div className="description-box">
                <h4>Acloud - GLM</h4>
                <p>
                  The Global License Manager (GLM) is the master licensing and
                  billing system for A10 vThunder. GLM collects information from
                  the distributed LLPs and issues licenses for the vThunder
              ...
              <div className="link-box">
                <a href="https://glm.a10networks.com/" target="_blank">
                  Details
                </a>
                <a className="popup-modal-dismiss">Close</a>
              </div>
            ...
            <div id="modal-trm" className="popup-modal mfp-hide">
              <img
                className="scale-with-grid"
                src="images/portfolio/modals/trm.png"
                alt=""
              />
              <div className="description-box">
                <h4>TRM</h4>
              ...
              <div className="link-box">
                <a href="https://www.via-trm.com/" target="_blank">
                  Details
                </a>
                <a className="popup-modal-dismiss">Close</a>
              </div>
